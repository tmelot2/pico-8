...
function gameoverinit()
  ...
  stars={}
  for i=1,20 do
    add(stars,{x=frnd(100),y=frnd(100),s=1+frnd(3)})
  end
end
...
function highscoredraw()
  ...
  for i=1,#stars do
    ...
    if stars[i].s==3 then
      c=7
    elseif stars[i].s==2 then
      c=13
    end
    pset(stars[i].x, stars[i].y, c)
  end
  clip()
...

